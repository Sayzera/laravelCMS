    ...
    <div class="sidebar-content js-simplebar" data-simplebar="init">
                            ...
                            <ul class="sidebar-nav">
                                    ...
                                    <ul id="pages" class="sidebar-dropdown list-unstyled collapse "
                                        ...
                                        <li class="sidebar-item"><a class="sidebar-link"
                                                href="pages-pricing.html">Pricing <span
                                                    class="sidebar-badge badge bg-primary">Pro</span></a></li>
                                        <li class="sidebar-item"><a class="sidebar-link" href="pages-chat.html">Chat
                                                <span class="sidebar-badge badge bg-primary">Pro</span></a></li>
                                ...
                                <li class="sidebar-item">
                                    ...
                                    <ul id="ui" class="sidebar-dropdown list-unstyled collapse "
                                        ...
                                        <li class="sidebar-item"><a class="sidebar-link" href="ui-cards.html">Cards</a>
                                        </li>
                                        <li class="sidebar-item"><a class="sidebar-link"
                                ...
                                <li class="sidebar-item">
                                    ...
                                    <ul id="maps" class="sidebar-dropdown list-unstyled collapse "
                                        ...
                                        <li class="sidebar-item"><a class="sidebar-link" href="maps-google.html">Google
                                                Maps</a></li>
                                        <li class="sidebar-item"><a class="sidebar-link" href="maps-vector.html">Vector
                                                Maps <span class="sidebar-badge badge bg-primary">Pro</span></a></li>
                                    </ul>
                                </li>
                                    ...
                                    <ul id="multi" class="sidebar-dropdown list-unstyled collapse"
                                        ...
                                        <li class="sidebar-item">
                                            <a data-bs-target="#multi-2" data-bs-toggle="collapse"
                                                class="sidebar-link collapsed" aria-expanded="false">Two Levels</a>
                                        ...
                                        <li class="sidebar-item">
                                            <a data-bs-target="#multi-3" data-bs-toggle="collapse"
                                                class="sidebar-link collapsed" aria-expanded="false">Three Levels</a>
                                            <ul id="multi-3" class="sidebar-dropdown list-unstyled collapse">
                                                <li class="sidebar-item">
                                                    <a data-bs-target="#multi-3-1" data-bs-toggle="collapse"
                                                        class="sidebar-link collapsed" aria-expanded="false">Item 1</a>
        ...
        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
            <div class="simplebar-scrollbar"
                style="height: 185px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
        </div>
    </div>
</nav>